...
//------------------------------------------------------------------------------
//
// PHP Connection Script for PHPMaker 2019
...
// Check if PHP 5.5 or later
if (version_compare(PHP_VERSION, "5.5.0") < 0)
	die("This script requires PHP 5.5 or later. You are running " . phpversion() . ".");

$debug = FALSE; // Change to TRUE to view the XML as HTML

// Get parameters
$majorversion = "2019"; // DO NOT CHANGE!
...
<p>(C) 2019 e.World Technology Ltd.</p>
</body>
</html>
<?php
/**
